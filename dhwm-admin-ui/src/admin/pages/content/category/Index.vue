<template>
  ...
  <div class="box">
    <el-table :data="listData.items" row-key="id" default-expand-all v-loading="is.loading">
      ...
      <el-table-column prop="content_count" label="文章数" width="70" align="center" class-name="cell-px-0" sortable/>
...
const cans = useCans('content.category', ['view', 'create', 'update', 'delete']);
