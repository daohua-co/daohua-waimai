...
const formActions = new FormActions(contentCategoryStore, formRef, {
  id: 0,
  title: '',
  asc_num: 50,
  intro: '',
...
defineExpose({
  create() {
    create();
    parentOptions.value = contentCategoryStore.listData.items;
  },
  edit(id) {
...
window.parentOptions = parentOptions;
</script>
