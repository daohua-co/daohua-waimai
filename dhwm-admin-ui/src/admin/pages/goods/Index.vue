<template>
  ...
  <div class="box">
    <el-table :data="listData.items" @selection-change="(items) => selectChange(items)" stripe v-loading="is.loading">
  ...
  <Pagination :list-store="goodsStore"/>
...
load({'with-category': 1}, {categories: goodsCategoryStore.listData.items});
