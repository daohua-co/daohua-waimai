...
import { adminRoleStore, adminPermissionStore } from '/src/admin/stores';
import FormDialog from './FormDialog.vue';
import ShowDrawer from './ShowDrawer.vue';

// 权限
const cans = useCans('administrator.role', ['view', 'create', 'update', 'delete']);
const {
  listData,
  is,
  load,
...
load({'with-permissions': 1}, {permissions: adminPermissionStore.listData.items});
</script>
